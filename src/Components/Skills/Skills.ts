...
export const allSkillNames: Array<SkillNameType> = [ATHLETICS, COMMON_KNOWLEDGE, FIGHTING, FAITH, GAMBLING, INTIMIDATION,
  ...
  TAUNT, THIEVERY];
export const allNonCombatSkillNames: Array<SkillNameType> = [ATHLETICS, COMMON_KNOWLEDGE, FAITH, GAMBLING, INTIMIDATION,
    NOTICE, OCCULT, PERFORMANCE, PERSUASION, REPAIR, RESEARCH, RIDING, SCIENCE, SPELLCASTING, STEALTH, SURVIVAL,
    TAUNT, THIEVERY];
